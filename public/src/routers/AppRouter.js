...
import DraftSummary from '../components/team-build/draft-group/DraftSummary';
    ...
    <BrowserRouter>
        <div>
            ...
            <Switch>
                ...
                <Route path="/team/draft" component={DraftPage} exact={true}/>
                <Route path="/team/draftSummary" component={DraftSummary} />
